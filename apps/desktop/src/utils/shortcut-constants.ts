...
export const MAC_SPECIAL_KEYCODES = new Set<number>([
  ...
  MAC_KEYCODES.TAB,
  MAC_KEYCODES.ENTER,
  MAC_KEYCODES.ENTER_LEGACY,
  MAC_KEYCODES.KEYPAD_ENTER,
  MAC_KEYCODES.ESCAPE,
  MAC_KEYCODES.DELETE,
...
const RESERVED_SHORTCUTS_MACOS_BASE: number[][] = [
  ...
  // [MAC_KEYCODES.CMD, MAC_KEYCODES.SPACE], // Not universally reserved — user-configurable (Spotlight, Input Sources)
  // Screenshots
